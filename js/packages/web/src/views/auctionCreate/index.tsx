  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          {/* Listing for the very 1st time? <a>Read our sellers' guide.</a> */}
        </p>
      </Row>
...
const TierTableStep = (props: {
  ...
  return (
    <>
      ...
      <Row>
        <Button size="large" onClick={props.confirm} className="action-btn">
          Continue to Review
        </Button>
      </Row>
    </>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with WIS...
      </div>
